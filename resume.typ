...
#set page(paper: "us-letter", margin: (top: 0.647in, bottom: 0.647in, left: 0.5in, right: 0.5in), footer: text(
...
#experience([#secret("undisclosed-financial-institution", default: [#blackout(8)#sym.space.hair])], (
  position([Dev Intern], from: [May 2026], to: [Aug 2026], location: [New York, NY]),
))[
  - Worked on libraries and CI/CD tooling for web development.
]
...
#experience([Google], (
  ...
  - (2025) Built a data pipeline for evaluating advertisers' potential earning upside with target ROAS bidding.
  - (2024) Implemented a feature in the Google Search math solver and a related Gemini integration.
]
...
#experience([Taichi Graphics], position(
  ...
  - Implemented various refactors and small-scale compiler passes.
]

#experience([Chinese Academy of Sciences], position(
  [Intern Research Engineer (PLCT Lab, ISCAS)],
  from: [Oct 2020],
  to: [Oct 2021],
  location: [Beijing, China],
))[
  - Early contributor to the open-source HoTT proof assistant #link("https://github.com/aya-prover/aya-dev")[Aya Prover].
]
...
#project([Inkclip], "https://github.com/coclique/inkclip")[
  - A lightweight e-paper wearable accessory, as an exercise in blending technology and self-expression.
  - Custom STM32-based PCB, Rust (#link("https://embassy.dev/")[embassy]) firmware, and #link("https://svelte.dev/")[Svelte]-based web interface communicating via #link("https://developer.mozilla.org/en-US/docs/Web/API/WebHID_API")[WebHID].
]
...
#project([Lilynet (AS401736)], "https://daylily.network/")[
  ...
  - 3 virtual PoPs providing services such as authoritative DNS, Tor relays, IPv6 tunneling, and anycast routing.
]
...
= Miscellaneous
  ...
  - *Natural languages:* bilingual in English and Mandarin Chinese.
]
